...
const app = express();
const conString = 'postgres://The99missedcalls@localhost:5432/lab10';// TODO: Don't forget to set your own conString
  ...
  app.put('/articles/:id', function(request, response) {
    ...
    .then(function() {
      ...
      client.query(
        ...
        WHERE article_id = $6;
        `,
        [request.body.title, request.body.category, request.body.publishedOn, request.body.body, request.body.author_id, request.body.article_id, request.params.id]
      )
    })
    .then(function() {
